...
import { Truck, User, MapPin, Calendar, CheckCircle } from 'lucide-react';
    ...
    <div className="container mx-auto py-8 px-4 md:px-6">
      ...
      {rentals.length === 0 ? (
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {rentals.map(rental => (
            <Card key={rental.id} className="flex flex-col shadow-md hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
