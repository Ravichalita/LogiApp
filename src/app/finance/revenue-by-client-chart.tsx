...
export function RevenueByClientChart({ data }: RevenueByClientChartProps) {
    ...
    const legendItemsCount = data.length;
    // Assuming 2 items per row and each row takes about 24px
    const legendHeight = Math.ceil(legendItemsCount / 2) * 24; 
    const chartHeight = 250 + legendHeight;
